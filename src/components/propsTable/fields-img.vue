<template>
    <div class="field-container">
        <a-image :width="100" :height="100" :src="imgSrc"
        ...
        <div class="img-tool">
            ...
            <CropperModal v-model:showModal="showModal" :imgSrc="$props.value" :success-callback="handleChange">
                <a-button :icon="h(ScissorOutlined)" @click="showModal = true">裁剪图片</a-button>
            </CropperModal>
        </div>
    </div>
...
import { CloudUploadOutlined, ScissorOutlined } from '@ant-design/icons-vue'
